                ...
                <?php
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            if($row["user_role"] == 0) { //user_role = 0 => normal user
                                echo "<td class='text-center px-4 py-2 border'>User</td>";
                                echo "<td class='text-center px-4 py-2 border'><a href='./promote.php?user_id=".$row["user_id"]."' class='text-green-700 underline underline-offset-2'>Promote</a></td>";
                            } elseif($row["user_role"] == 1) { //user_role = 1 => super user
                                echo "<td class='text-center px-4 py-2 border'>Super-User</td>";
                                echo "<td class='text-center px-4 py-2 border'><a href='./demote.php?user_id=".$row["user_id"]."' class='text-red-700 underline underline-offset-2'>Demote</a></td>";}
                            echo "</tr>";
                            $count++;
                        }
                    } else {
