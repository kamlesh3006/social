...
<body x-data="{ open: false, showModal: false, authenticationModal: false}" x-bind:class="{ 'overflow-hidden': showModal || authenticationModal }" style="background-color: #FAFBFB; min-height: 100vh; display: flex; flex-direction: column;">
<div class="content">
